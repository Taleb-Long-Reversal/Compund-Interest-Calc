      ...
      <div className="flex">
        <label htmlFor="initialAmount">
          ...
          <input
            ...
            name="initialAmount"
            value={initialAmount}
            onChange={({ target }) => setState({ ...state, initialAmount: Number(parseFloat(target.value)) })}
          />
        </label>
        ...
        <label htmlFor="growthRate">
          ...
          <input
            ...
            name="growthRate"
            value={growthRate}
            onChange={({ target }) => setState({ ...state, growthRate: Number(parseFloat(target.value)) })}
          />
        </label>
        <label htmlFor="monthlyContribution">
          ...
          <input
            ...
            onChange={({ target }) =>
              setState({ ...state, monthlyContribution: Number(parseFloat(target.value)) })
            }
          />
        </label>
      </div>
